...
class SubtasksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create subtask" do
    assert_difference("Subtask.count") do
      post subtasks_url, params: { subtask: { completed_at: @subtask.completed_at, description: @subtask.description, done: @subtask.done, task_id: @subtask.task_id, title: @subtask.title } }
    end
  ...
  test "should update subtask" do
    patch subtask_url(@subtask), params: { subtask: { completed_at: @subtask.completed_at, description: @subtask.description, done: @subtask.done, task_id: @subtask.task_id, title: @subtask.title } }
